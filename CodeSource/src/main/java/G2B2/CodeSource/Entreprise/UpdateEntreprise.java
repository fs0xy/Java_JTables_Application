...
public class UpdateEntreprise extends JFrame {

	/* Déclaration des attributs */
	private JPanel panneau;
	private JTextField champNom = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getnomE(), 15);
	private JTextField champTelephone = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getTelephoneE(), 15);
	private JTextField champEmail = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getEmailE(), 15);
	private JTextField champAdresse = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getAdresseE(), 15);
	private JTextField champAnneeStage = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getAnneeStageE(), 5);
	private JTextField champAnneeTaxe = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getAnneeTaxeE(), 5);
	private JTextField champMontantTaxe = new JTextField(
			AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getMontantTaxeE(), 15);
	...
	/**
	 * Constructeur permettant de faire apparaitre une fenêtre de modification d'un
	 * stagiaire
	 */
	public UpdateEntreprise() {
		super("Modification d'une entreprise");
	...
	JPanel panneauDeContenu() {
		...
		/*
		 * Cherche si les boutons sont sélectionnées et les resélectionne en conséquent
		 */
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonStage()
				.equals("Oui")) {
			boutonStageOui.setSelected(true);
		}
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonStage()
				.equals("Non")) {
		...
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonTaxe()
				.equals("Oui")) {
			boutonTaxeOui.setSelected(true);
		}
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonTaxe()
				.equals("Non")) {
		...
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonContact()
				.equals("Oui")) {
			boutonContactOui.setSelected(true);
		}
		if (AddEntreprise.arrayEntreprise.get(Interface.tableEntreprise.getSelectedRow()).getBoutonContact()
				.equals("Non")) {
		...
		/*
		 * Si le bouton stage est sélectionné à non alors le champ devient non éditable
		 */
		...
		/*
		 * Si le bouton taxe est sélectionné à non alors les champs deviennent non
		 * éditables
		 */
	...
	private void actionBoutonOk() {
		...
		if (donneesValidesChamps() == true && donneesValidesChampStage() == true && donneesValidesChampTaxe() == true
			...
			AddEntreprise.arrayEntreprise.set(Interface.tableEntreprise.getSelectedRow(), entre);

			Interface.modelEntreprise.setValueAt(champNom.getText(), Interface.tableEntreprise.getSelectedRow(), 0);
			Interface.modelEntreprise.setValueAt(champTelephone.getText(), Interface.tableEntreprise.getSelectedRow(),
					1);
			Interface.modelEntreprise.setValueAt(champEmail.getText(), Interface.tableEntreprise.getSelectedRow(), 2);
			Interface.modelEntreprise.setValueAt(champAdresse.getText(), Interface.tableEntreprise.getSelectedRow(), 3);
			Interface.modelEntreprise.setValueAt(groupeStage.getSelection().getActionCommand(),
					Interface.tableEntreprise.getSelectedRow(), 4);
			Interface.modelEntreprise.setValueAt(champAnneeStage.getText(), Interface.tableEntreprise.getSelectedRow(),
					5);
			Interface.modelEntreprise.setValueAt(groupeTaxe.getSelection().getActionCommand(),
					Interface.tableEntreprise.getSelectedRow(), 6);
			Interface.modelEntreprise.setValueAt(champAnneeTaxe.getText(), Interface.tableEntreprise.getSelectedRow(),
					7);
			Interface.modelEntreprise.setValueAt(champMontantTaxe.getText(), Interface.tableEntreprise.getSelectedRow(),
					8);
			Interface.modelEntreprise.setValueAt(groupeContact.getSelection().getActionCommand(),
					Interface.tableEntreprise.getSelectedRow(), 9);
